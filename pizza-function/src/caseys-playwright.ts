...
export async function main(order: OrderOptions, options: LaunchOptions) {
    ...
    if (ENABLE === 'true') {
        // Ugly but it works
        await page.locator('#App > main > div.full-site-width > section > div.text-center.CheckoutPage__sticky-btn.visible > button').click();
    }
    ...
    async function checkout() {
        ...
        await page.locator('[data-automation-id="checkoutButton"]:visible').first().click();
