module github.com/mattdsteele/query-spot
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.9.0 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/location v1.16.3 // indirect
